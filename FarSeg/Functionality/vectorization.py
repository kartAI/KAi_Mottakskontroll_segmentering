...
# Step 4: Vectorize skeleton and filter short segments
...
# Step 5: Create graph and intersections
G = nx.Graph()
...
# Step 6: Snap poorly segmented roads
...
# Step 7: Convert to GeoJSON format
ZONE = "32N"
